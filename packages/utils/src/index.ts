...
import retry from '@umijs/deps/compiled/async-retry';
...
import sortPackage from '@umijs/deps/compiled/sort-package-json';
import tar from '@umijs/deps/reexported/tar';
