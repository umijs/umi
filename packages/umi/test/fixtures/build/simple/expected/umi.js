...
var _reactDom = _interopRequireDefault(__webpack_require__(172));

// runtime plugins
window.g_plugins = __webpack_require__(173);
...
var oldRender = () => {
  var rootContainer = window.g_plugins.apply('rootContainer', {
    initialValue: _react.default.createElement(__webpack_require__(183).default)
  });
...
$export($export.P + $export.F * (fails(function () {
  ...
  test.sort(null);
  // Old WebKit
}) || !__webpack_require__(101)($sort)), 'Array', {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(11)(proto, TO_PRIMITIVE, __webpack_require__(104));
...
// create history
window.g_history = __webpack_require__(161).default({
...
var strictUriEncode = __webpack_require__(167);
var objectAssign = __webpack_require__(168);
var decodeComponent = __webpack_require__(169);
...
var _dynamic = _interopRequireDefault(__webpack_require__(184));

var _renderRoutes = _interopRequireDefault(__webpack_require__(185));

var Router = _reactRouterDom.Router;
var routes = [{
  "path": "/",
  "exact": true,
  "component": __webpack_require__(186).default
}];
