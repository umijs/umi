...
var _link = _interopRequireDefault(__webpack_require__(38));
...
var oldRender = () => {
  var rootContainer = window.g_plugins.apply('rootContainer', {
    initialValue: _react.default.createElement(__webpack_require__(35).default)
  });
...
// create history
window.g_history = __webpack_require__(41).default({
...
var _dynamic = _interopRequireDefault(__webpack_require__(36));

var _renderRoutes = _interopRequireDefault(__webpack_require__(37));
...
// EXTERNAL MODULE: ./packages/umi-build-dev/node_modules/umi-history/createBrowserHistory.js
var createBrowserHistory = __webpack_require__(8);
var createBrowserHistory_default = /*#__PURE__*/__webpack_require__.n(createBrowserHistory);

// CONCATENATED MODULE: ./packages/umi/lib/utils.js
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }
...
// CONCATENATED MODULE: ./packages/umi/lib/createHistory.js


/* harmony default export */ var createHistory = __webpack_exports__["default"] = (function (opts) {
