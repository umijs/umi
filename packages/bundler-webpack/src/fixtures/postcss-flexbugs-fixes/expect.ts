...
export default ({ indexCSS }: IExpectOpts) => {
  ...
  // media
  expect(indexCSS).toContain(`@media screen and (min-width: 500px) and (max-width: 1200px) {`);
  expect(indexCSS).toContain(`@media screen and (min-width: 600px) and (max-width: 1000px) {`)
  // grid
